...
const signitoryList =(container)=>{
    const singitories = Parser.getAssociated(
        Parser.Data.Signitories, 'Type', container.dataset.sigtype, 'Name'
    )
...
const signitoryLists = document.querySelectorAll('#Signitories .signitoryList')
